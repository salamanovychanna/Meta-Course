      ...
      <div className="project-description-content">
        <div className="project-description-text-section">
          ...
          <p style={{ color: "white" }}>
            ...
            {width=='big' ? <p>Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Distinctio mollitia quisquam accusamus sed magnam
            quasi delectus. Fugit libero cum cupiditate animi aspernatur, iste,
            ...
            aliquid, nihil accusantium porro rerum eius voluptas sint illum!</p> : null}
          </p>
        </div>
        {width == 'big' ? <div className="project-description-img-section">
          <img
